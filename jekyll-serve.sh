...
echo -e "\e[1;31mBuild Terms CHANGELOG.md"
bundle exec git log --decorate  --pretty=format:'- %s ([%h](https://github.com/gruntwork-io/gruntwork-io.github.io/commit/%h))' --no-merges _data/terms-of-service.yml > pages/terms/CHANGELOG.md
echo -e "\e[1;32mFinished building CHANGELOG.md"
